            ...
            <div class="card-body">
                <form action="{{ route('proses_ti.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="klausul_id" id="klausul_id" class="form-control" required>
                            ...
                            @foreach ($klausuls as $klausul)
                                <option value="{{ $klausul->id }}" {{ old('klausul_id') == $klausul->id ? 'selected' : '' }}>{{ $klausul->nama_klausul }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="kode_proses" class="form-label">Kode Proses</label>
                        <input type="text" name="kode_proses" id="kode_proses" class="form-control" maxlength="10" value="{{ old('kode_proses') }}" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="praktik_manajemen" id="praktik_manajemen" class="form-control" maxlength="255" value="{{ old('praktik_manajemen') }}" required>
                    </div>
                    <div class="mb-3">
